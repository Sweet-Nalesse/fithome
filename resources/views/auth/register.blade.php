                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('register') }}" class="needs-validation" novalidate>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="name" name="name" value="{{ old('name') }}" required pattern="[A-Za-zА-Яа-яЁё\s]+" title="Имя не должно содержать цифр." required>
                                <div class="invalid-feedback">Пожалуйста, введите корректное имя без цифр.</div>
                            </div>
                            <div class="form-group">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            nameInput.addEventListener('input', function() {
                ...
                if (!pattern.test(nameInput.value)) {
                    nameInput.setCustomValidity('Имя не должно содержать цифр.');
                } else {
